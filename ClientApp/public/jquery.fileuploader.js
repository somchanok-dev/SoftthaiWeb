                                    ...
                                    item.popup.editor.cropper = {
                                        ...
                                        setAreaInfo: function(type) {
                                            ...
                                            cropper.$editor.find('.area-info').html((cropper.isResizing || type == 'size' ? [
                                                ...
                                                ' ',
                                                'Y: ' + Math.round(cropper.crop.top / cropper.crop.cfHeight / scale) + 'px'
                                            ]).join(''));
                                        },
    ...
    $.fn.fileuploader.defaults = {
        ...
        thumbnails: {
            ...
            item: '<li class="fileuploader-item">' +
                ...
                '<a href="${url}" class="mr-1" title="${captions.download}" download><button type="button" class="btn btn-sm btn-primary"><i class="fileuploader-icon-download"></i></button></a>' +
                '<button type="button" class="btn btn-sm btn-danger btn-remove" title="${captions.remove}"><i class="fa fa-remove"></i></button>' +
                '</div>' +
                '</div>' +
            ...
            item2: '<li class="fileuploader-item">' +
                ...
                '</div>' +
                '<div class="column-actions">' +
                '<a href="${data.url}" class="mr-1" title="${captions.download}" download><button type="button" class="btn btn-sm btn-primary"><i class="fileuploader-icon-download"></i></button></a>' +
                '<button type="button" class="btn btn-sm btn-danger btn-remove" title="${captions.remove}"><i class="fa fa-remove"></i></button>' +
                '</div>' +
                '</div>' +
                '</li>',
                ...
                template: function(data) {
                    ...
                    return '<div class="fileuploader-popup-preview">' +
                        ...
                        (data.url ? '<li>' +
                            ...
                            // '</a>' +
                            '<a href="' + data.url + '" class="mr-1" title="Download" download=""><button type="button" class="btn btn-sm btn-primary"><i class="fileuploader-icon-download"></i></button></a>' +
                            '</li>' : ''
                        ) +
                        '<li style="margin-left: unset !important;">' +
                        //'<button type="button" data-action="remove" title="Remove" class="btn btn-sm btn-danger btn-remove" style="padding: 0.25rem 0.5rem !important;">' +
        ...
        dialogs: {
            alert: function (text) {
                return SwAlert.Error("ไม่สามารถดำเนินการได้", text);
            },
            confirm: function(text, callback) {
                SwAlert.Confirm("ยืนยันการดำเนินการ", text, function() {
                    callback();
                    swal.close();
                });
